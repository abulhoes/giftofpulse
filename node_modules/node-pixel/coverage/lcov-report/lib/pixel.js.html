...
<html lang="en">
<head>
    <title>Code coverage report for lib/pixel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> pixel.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">76.58% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>242/316</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>241/315</span>
      </div>
    </div>
  </div>
...
777
778
779</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof(g_table) !== "undefined") {
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (firmata == undefined) {
<span class="cstat-no" title="statement not covered" >                    throw "Either a firmata or board object is required";</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
                // figure out where we are writing to
                var port = firmata.sp || <span class="branch-1 cbranch-no" title="branch not covered" >firmata;</span>
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (port.write === undefined) {
<span class="cstat-no" title="statement not covered" >                    throw "Node Pixel FIRMATA controller only supports firmata IO that can write out";</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (! global.IS_TEST_MODE) {
                    // don't need to worry about this test if we're using a mock
<span class="cstat-no" title="statement not covered" >                    if (firmata.firmware.name !== 'node_pixel_firmata.ino') {</span>
<span class="cstat-no" title="statement not covered" >                        throw new Error("Please upload NodePixel Firmata to the board");</span>
                    }
                }
&nbsp;
...
&nbsp;
        ...
        _shift: {
            value: <span class="fstat-no" title="function not covered" >function(amt, direction, wrap) {</span>
                // shifts the strip in the appropriate direction.
                //
<span class="cstat-no" title="statement not covered" >                let wrap_val = wrap ? PIXEL_SHIFT_WRAP : 0;</span>
<span class="cstat-no" title="statement not covered" >                let strip = strips.get(this);</span>
...
<span class="cstat-no" title="statement not covered" >                data[1] = PIXEL_COMMAND;</span>
<span class="cstat-no" title="statement not covered" >                data[2] = PIXEL_SHIFT;</span>
<span class="cstat-no" title="statement not covered" >                data[3] = (amt | direction | wrap_val) &amp; FIRMATA_7BIT_MASK;</span>
<span class="cstat-no" title="statement not covered" >                data[4] = END_SYSEX;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                strip.port.write(new Buffer(data));</span>
            },
        },
    },
    I2CBACKPACK: {
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!opts.address) {
                    opts.address = I2C_DEFAULT;
                }
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (io == undefined) {
<span class="cstat-no" title="statement not covered" >                    throw "An IO object is required to I2C controller";</span>
                }
&nbsp;
                // work out the map of strips and pixels.
                if (typeof(strip_definition[0]) == "undefined") {
                ...
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (parseInt(strip_definition[0]) != NaN) {
...
<span class="cstat-no" title="statement not covered" >                        if (e instanceof Error &amp;&amp; e.name == "EIO") {</span>
<span class="cstat-no" title="statement not covered" >                            this.emit("np_i2c_write_error", data);</span>
                        }
                    }
                    process.nextTick(function() {
...
<span class="cstat-no" title="statement not covered" >                    if (e instanceof Error &amp;&amp; e.name == "EIO") {</span>
<span class="cstat-no" title="statement not covered" >                        this.emit("np_i2c_write_error", "PIXEL_SHOW");</span>
                    }
                }
            },
        },
        strip_color: {
            value: <span class="fstat-no" title="function not covered" >function(color) {</span>
<span class="cstat-no" title="statement not covered" >                var strip = strips.get(this);</span>
<span class="cstat-no" title="statement not covered" >                var data   = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                data[0] = PIXEL_SET_STRIP;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                data[1] = color &amp; FIRMATA_7BIT_MASK;</span>
<span class="cstat-no" title="statement not covered" >                data[2] = (color &gt;&gt; 7) &amp; FIRMATA_7BIT_MASK;</span>
<span class="cstat-no" title="statement not covered" >                data[3] = (color &gt;&gt; 14) &amp; FIRMATA_7BIT_MASK;</span>
<span class="cstat-no" title="statement not covered" >                data[4] = (color &gt;&gt; 21) &amp; FIRMATA_7BIT_MASK;</span>
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                    strip.io.i2cWrite(strip.i2c_address, data);</span>
                } catch (e) {
<span class="cstat-no" title="statement not covered" >                    if (e instanceof Error &amp;&amp; e.name == "EIO") {</span>
<span class="cstat-no" title="statement not covered" >                        this.emit("np_i2c_write_error", data);</span>
                    }
...
<span class="cstat-no" title="statement not covered" >                let strip = strips.get(this);</span>
<span class="cstat-no" title="statement not covered" >                let data = [];</span>
<span class="cstat-no" title="statement not covered" >                data[0] = PIXEL_SHIFT;</span>
<span class="cstat-no" title="statement not covered" >                data[1] = (amt | direction | wrap_val) &amp; FIRMATA_7BIT_MASK;</span>
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                    strip.io.i2cWrite(strip.i2c_address, data);</span>
                } catch (e) {
<span class="cstat-no" title="statement not covered" >                    if (e instanceof Error &amp;&amp; e.name == "EIO") {</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (! warning &amp;&amp; gamma == GAMMA_DEFAULT &amp;&amp; ! global.IS_TEST_MODE) {
<span class="cstat-no" title="statement not covered" >        console.info("INFO: Default gamma behaviour is changing");</span>
<span class="cstat-no" title="statement not covered" >        console.info("0.9 - gamma=1.0 - consistent with pre-gamma values");</span>
<span class="cstat-no" title="statement not covered" >        console.info("0.10 - gamma=2.8 - default fix for WS2812 LEDs");</span>
<span class="cstat-no" title="statement not covered" >        warning = true;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Strip)) {
<span class="cstat-no" title="statement not covered" >        return new Strip(opts);</span>
    }
&nbsp;
    var controller;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof opts.controller === "string") {
        controller = Controllers[opts.controller];
    } else {
<span class="cstat-no" title="statement not covered" >        controller = opts.controller || Controllers["FIRMATA"];</span>
    }
&nbsp;
    this.dep_warning = {
        stripLength: false,
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof this.initialize === "function") {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (color) {
        ...
        if(typeof(color) === "object") {
            ...
            try {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (e instanceof TypeError &amp;&amp; ColorString.get(color) === null ) {
                    stripcolor = null;
                }
            }
        }
...
&nbsp;
Strip.prototype.shift = <span class="fstat-no" title="function not covered" >function(amt, direction, wrap) {</span>
...
<span class="cstat-no" title="statement not covered" >        let start_element = 0;</span>
<span class="cstat-no" title="statement not covered" >        if (direction == SHIFT_FORWARD) {</span>
<span class="cstat-no" title="statement not covered" >            start_element = this.length - amt;</span>
        }
<span class="cstat-no" title="statement not covered" >        let tmp_pixels = strip.pixels.splice(start_element, amt);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (tmp_pixels.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            let px = tmp_pixels.pop();</span>
&nbsp;
            // set the pixel off if not wrapping.
<span class="cstat-no" title="statement not covered" >            if (! wrap) {</span>
<span class="cstat-no" title="statement not covered" >                px.color("#000");</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (direction == SHIFT_FORWARD) {</span>
<span class="cstat-no" title="statement not covered" >                strip.pixels.unshift(px);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                strip.pixels.push(px);</span>
            }
        }
&nbsp;
        // renumber the items so the addresses are correct for display
<span class="cstat-no" title="statement not covered" >        strip.pixels.forEach((px, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            px.address = index;</span>
        });
&nbsp;
        // now get the firmware to update appropriately as well.
<span class="cstat-no" title="statement not covered" >        this._shift(amt, direction, wrap);</span>
    }
};
&nbsp;
...
&nbsp;
    let strip = strips.get(this);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (! this.dep_warning.stripLength) {
...
function Pixel(opts) {
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Pixel)) {
<span class="cstat-no" title="statement not covered" >        return new Pixel(opts);</span>
    }
&nbsp;
    var controller;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        controller = opts.controller || Pixel_Controllers["FIRMATA"];</span>
    }
&nbsp;
    Object.defineProperties(this, controller);
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            let pixel = pixels.get(this);</span>
<span class="cstat-no" title="statement not covered" >            return pixel.address;</span>
        },
        set: <span class="fstat-no" title="function not covered" >function(newAddress) {</span>
<span class="cstat-no" title="statement not covered" >            let pixel = pixels.get(this);</span>
<span class="cstat-no" title="statement not covered" >            pixel.address = newAddress;</span>
        },
    });
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jan 16 2017 11:49:22 GMT+1100 (AEDT)
</div>
</div>
